...
+ (instancetype)ALDictionaryWithContentsOfJSONFile:(NSString *)filename error:(NSError **)error {
    NSInputStream *jsonFileStream = [NSInputStream inputStreamWithFileAtPath:filename];
    [jsonFileStream open];
    NSDictionary *contents = [NSJSONSerialization JSONObjectWithStream:jsonFileStream options:0 error:error];
    return contents;
}

- (NSString *)ALCompactJSONString:(NSError **)error {
