...
#import "ALAuthStatus.h"
#import "ALAuthorization.h"
#import "ALAutomaticAdapter.h"
#import <Foundation/Foundation.h>

@interface ALAuthorizationJob : NSObject

@property (nonatomic, readonly) NSString *clientID;
@property (nonatomic, readonly) NSString *adapterID;
@property (nonatomic, readonly) ALAuthStatus status;
@property (nonatomic, readonly) NSError *error;

typedef void (^ALAuthorizationJobOnStatus)(ALAuthStatus inAuthStatus, NSError *inError);
typedef void (^ALAuthorizationJobOnAuthorized)(ALAutomaticAdapter *inAdapter, NSString *inClientID, ALAuthorizationJobOnStatus inStatusCallback);
typedef void (^ALAuthorizationJobOnWaitVerdict)(ALAuthStatus inAuthStatus, NSError *inError);

+ (instancetype)jobForAdapter:(NSString *)inAdapterID;

+ (instancetype)jobForURL:(NSURL *)inAccountAuthRedirectURL;

+ (BOOL)waitIfAuthorizingAdapter:(ALAutomaticAdapter *)inAdapter
